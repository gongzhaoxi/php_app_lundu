<?php /*a:2:{s:71:"/www/wwwroot/lundu.ecloudm.com/app/backend/view/system/crontab/add.html";i:1755524162;s:66:"/www/wwwroot/lundu.ecloudm.com/app/backend/view/common/layout.html";i:1764860923;}*/ ?>
<!DOCTYPE html>
...
<form class="layui-form">
    ...
    <div class="wait-body-content">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="status" value="1" title="立即启动" checked>
                <input type="radio" name="status" value="2" title="暂停执行">
            </div>
        </div>
    </div>
