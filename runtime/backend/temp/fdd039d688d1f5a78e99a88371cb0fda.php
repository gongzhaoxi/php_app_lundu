<?php /*a:2:{s:71:"/www/wwwroot/lundu.ecloudm.com/app/backend/view/sailing/month_stat.html";i:1764079894;s:66:"/www/wwwroot/lundu.ecloudm.com/app/backend/view/common/layout.html";i:1764860923;}*/ ?>
<!DOCTYPE html>
    ...
    <form class="layui-form layui-search">
        <div class="layui-form-item">
            <div class="layui-inline">
                <label for="name" class="layui-form-label">月份：</label>
                <div class="layui-input-inline">
                    <input type="text" id="sailing_date" name="sailing_date"    class="layui-input" placeholder="请输入月份" autocomplete="off">
                </div>
            </div>
            <div class="layui-inline">
...
<script>
    layui.use(['laydate'],function() {
		layui.laydate.render({elem: '#sailing_date', type: 'month', range: '至',trigger: 'click'});
        // 渲染表格
        let table = waitUtil.table({
            elem: '#wait-table-list'
            ,url: '<?php echo route("Sailing/monthStat"); ?>'
			,toolbar:false
            ,defaultToolbar: false
			,height:'full-210'
            ,cols: [[
                {type:"numbers",title:'序号', width:60, align:'center'},
				{field:'sailing_date', title:'月份', align:'center'},
		...
		$('.export').click(function(){
			exportData(layui.form.val('layui-search'),'<?php echo route("Sailing/exportMonthStat"); ?>',10000);
		})
        // 逻辑事件
        waitUtil.event({
