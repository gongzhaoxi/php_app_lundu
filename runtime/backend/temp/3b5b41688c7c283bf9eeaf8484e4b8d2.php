<?php /*a:2:{s:66:"/www/wwwroot/lundu.ecloudm.com/app/backend/view/common/attach.html";i:1755524162;s:66:"/www/wwwroot/lundu.ecloudm.com/app/backend/view/common/layout.html";i:1764860923;}*/ ?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="file-container">
        <div class="folder">
            <ul class="groups"> </ul>
            <div class="footer">
                <button type="button" class="layui-btn layui-btn-primary layui-btn-sm cateCreate <?php echo check_perms('cateAdd', false); ?>">添加分组</button>
            </div>
        </div>
        <div class="attach">
            <div class="header">
                <?php if($type==10): ?>
                    <button type="button" class="layui-btn layui-btn layui-btn-sm layui-btn-default <?php echo check_perms('upload/permanent', false); ?>" id="imageUpload">上传图片</button>
                <?php elseif($type==20): ?>
                    <button type="button" class="layui-btn layui-btn layui-btn-sm layui-btn-default <?php echo check_perms('upload/permanent', false); ?>" id="videoUpload">上传视频</button>
                <?php elseif($type==30): ?>
                    <button type="button" class="layui-btn layui-btn layui-btn-sm layui-btn-default <?php echo check_perms('upload/permanent', false); ?>" id="packageUpload">上传压缩</button>
                <?php elseif($type==40): ?>
                    <button type="button" class="layui-btn layui-btn layui-btn-sm layui-btn-default <?php echo check_perms('upload/permanent', false); ?>" id="documentUpload">上传文件</button>
                <?php endif; ?>
                <div class="search">
...
<script>
    let limit   = parseInt('<?php echo htmlentities((string) $limit); ?>');
    let urlArr  = [];
    layui.use(['laytpl', 'laypage', 'upload'], function () {
        ...
        let type    = parseInt('<?php echo htmlentities((string) $type); ?>');
        let water   = Boolean('<?php echo isset($water) ? htmlentities((string) $water) : "true"; ?>');
        let cid     = -1;

        urlArr = JSON.parse('<?php echo $urls; ?>');
