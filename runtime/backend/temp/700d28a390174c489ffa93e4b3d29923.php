<?php /*a:2:{s:69:"/www/wwwroot/lundu.ecloudm.com/app/backend/view/system/log/index.html";i:1755524162;s:66:"/www/wwwroot/lundu.ecloudm.com/app/backend/view/common/layout.html";i:1764860923;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="layui-card">
        <div class="layui-card-body">
            ...
            <script type="text/html" id="table-operate">
                <button type="button" class="layui-btn layui-btn-xs layui-btn-primary <?php echo check_perms('detail'); ?>" lay-event="detail">
...
<script>
    layui.use(['laydate', 'form'], function() {
        ...
        let table = waitUtil.table({
            ...
            ,url: '<?php echo route("system.log/index"); ?>'
            ,toolbar: false
            ,cols: [[
        ...
        waitUtil.event({
            detail: function (obj) {
                waitUtil.popup({
                    title: '详情',
                    url: '<?php echo route("system.log/detail"); ?>?id='+obj.data.id,
                    area: ['600px', '500px'],
                    success: function () {}
                });
            }
