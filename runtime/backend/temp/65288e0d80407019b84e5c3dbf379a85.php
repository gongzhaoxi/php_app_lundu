<?php /*a:2:{s:70:"/www/wwwroot/lundu.ecloudm.com/app/backend/view/diy/contact/index.html";i:1755524162;s:66:"/www/wwwroot/lundu.ecloudm.com/app/backend/view/common/layout.html";i:1764860923;}*/ ?>
<!DOCTYPE html>
                ...
                <fieldset class="layui-elem-field">
                    ...
                    <div class="layui-field-box">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" id="datetime" name="datetime" value="<?php echo htmlentities((string) $detail['datetime']); ?>"
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" id="mobile" name="mobile" value="<?php echo htmlentities((string) $detail['mobile']); ?>"
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" id="qq" name="qq" value="<?php echo htmlentities((string) $detail['qq']); ?>"
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <div class="thumbnail" data-type="image" data-limit="1">
                                    <div class="musters">
                                        <div class="preview <?php if(!$detail['image']): ?>layui-hide<?php endif; ?>">
                                            <em class="layui-icon layui-icon-close"></em>
                                            <input type="hidden" id="image" name="image" value="<?php echo htmlentities((string) $detail['image']); ?>">
                                            <img src="<?php echo htmlentities((string) $detail['image']); ?>" alt="img">
                                        </div>
                                    </div>
                                    <div class="builder <?php if($detail['image']): ?>layui-hide<?php endif; ?>">
...
<script>
    layui.use(['form', 'laytpl'], function() {
        ...
        // 渲染数据
        renderTpl(JSON.parse('<?php echo $jsonp; ?>'));
        ...
        form.on('submit(addForm)', function(data){
            layer.confirm('确定保存当前配置吗?', function(index) {
                layer.close(index);
                waitUtil.ajax({
                    url: '<?php echo route("diy.contact/save"); ?>',
                    type: 'POST',
                    data: data.field
                });
