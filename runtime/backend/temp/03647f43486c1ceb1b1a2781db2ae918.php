<?php /*a:2:{s:66:"/www/wwwroot/lundu.ecloudm.com/app/backend/view/setting/email.html";i:1755524162;s:66:"/www/wwwroot/lundu.ecloudm.com/app/backend/view/common/layout.html";i:1764860923;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="layui-card">
            ...
            <div class="layui-card-body">
                    ...
                    <div class="layui-input-block">
                        <div class="layui-col-md4">
                            <select name="smtp_type" id="smtp_type">
                                ...
                                <option value="smtp" <?php if($detail['smtp_type']=="smtp"): ?>selected<?php endif; ?>>SMTP</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <div class="layui-col-md4">
                            <input type="text" id="smtp_host" name="smtp_host" value="<?php echo htmlentities((string) $detail['smtp_host']); ?>"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <div class="layui-col-md4">
                            <input type="text" id="smtp_port" name="smtp_port" value="<?php echo htmlentities((string) $detail['smtp_port']); ?>"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <div class="layui-col-md4">
                            <input type="text" id="smtp_user" name="smtp_user" value="<?php echo htmlentities((string) $detail['smtp_user']); ?>"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <div class="layui-col-md4">
                            <input type="text" id="smtp_pass" name="smtp_pass" value="<?php echo htmlentities((string) $detail['smtp_pass']); ?>"
                                   class="layui-input" autocomplete="off">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="layui-input-block">
                        <div class="layui-col-md4">
                            <select name="verify_type" id="verify_type">
                                ...
                                <option value="tls" <?php if($detail['verify_type']=="tls"): ?>selected<?php endif; ?>>TLS</option>
                                <option value="ssl" <?php if($detail['verify_type']=="ssl"): ?>selected<?php endif; ?>>SSL</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <div class="layui-col-md3">
                            <input type="text" id="from_user" name="from_user" value="<?php echo htmlentities((string) $detail['from_user']); ?>"
                                   class="layui-input" autocomplete="off">
                        </div>
    ...
    layui.use('form', function () {
        ...
        form.on('submit(addForm)', function(data) {
            layer.confirm('确定保存当前配置吗?', function (index) {
                layer.close(index);
                waitUtil.ajax({
                    url: '<?php echo route("setting.email/save"); ?>',
                    type: "POST",
                    data: data.field
                });
            });
        ...
        waitUtil.event({
            test: function () {
                ...
                layer.prompt({title: '请输入测试接收邮箱', formType: 3, value: ''}, function (value, index) {
                    ...
                    waitUtil.ajax({
                        url: '<?php echo route("setting.email/test"); ?>',
                        type: "POST",
