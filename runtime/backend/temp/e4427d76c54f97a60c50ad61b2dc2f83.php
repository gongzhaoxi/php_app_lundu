<?php /*a:2:{s:70:"/www/wwwroot/lundu.ecloudm.com/app/backend/view/sailing/year_stat.html";i:1764080126;s:66:"/www/wwwroot/lundu.ecloudm.com/app/backend/view/common/layout.html";i:1764860923;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="sailing_date" name="sailing_date"    class="layui-input" placeholder="请输入年份" autocomplete="off">
                </div>
            </div>
            <div class="layui-inline">
...
<script>
    layui.use(['laydate'],function() {
		layui.laydate.render({elem: '#sailing_date', type: 'year', range: '至',trigger: 'click'});
        // 渲染表格
        let table = waitUtil.table({
            elem: '#wait-table-list'
            ,url: '<?php echo route("Sailing/yearStat"); ?>'
			,toolbar:false
            ,defaultToolbar: false
			,height:'full-210'
            ,cols: [[
                {type:"numbers",title:'序号', width:60, align:'center'},
				{field:'sailing_date', title:'年份', align:'center'},
		...
		$('.export').click(function(){
			exportData(layui.form.val('layui-search'),'<?php echo route("Sailing/exportYearStat"); ?>',10000);
		})
        // 逻辑事件
        waitUtil.event({
