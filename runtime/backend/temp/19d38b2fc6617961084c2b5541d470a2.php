<?php /*a:2:{s:68:"/www/wwwroot/lundu.ecloudm.com/app/backend/view/auth/admin/edit.html";i:1764058810;s:66:"/www/wwwroot/lundu.ecloudm.com/app/backend/view/common/layout.html";i:1764860923;}*/ ?>
<!DOCTYPE html>
...
<form class="layui-form">
    ...
    <div class="wait-body-content">
            ...
            <div class="layui-input-block">
                <select id="dept_id" name="dept_id" lay-verType="tips">
                    ...
                    <?php if(is_array($dept) || $dept instanceof \think\Collection || $dept instanceof \think\Paginator): $i = 0; $__LIST__ = $dept;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <option value="<?php echo htmlentities((string) $vo['id']); ?>" <?php if($detail['dept_id']==$vo['id']): ?>selected<?php endif; ?>><?php echo htmlentities((string) $vo['html']); ?> <?php echo htmlentities((string) $vo['name']); ?></option>
        ...
        <!-- 所属岗位 -->
        <div class="layui-form-item layui-hide">
            <label for="post_id" class="layui-form-label">所属岗位：</label>
            <div class="layui-input-block">
                <select id="post_id" name="post_id" lay-verType="tips">
                    <option value="">请选择</option>
                    <?php if(is_array($post) || $post instanceof \think\Collection || $post instanceof \think\Paginator): $i = 0; $__LIST__ = $post;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <option value="<?php echo htmlentities((string) $vo['id']); ?>" <?php if($detail['post_id']==$vo['id']): ?>selected<?php endif; ?>><?php echo htmlentities((string) $vo['name']); ?></option>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
        </div>
            ...
            <div class="layui-input-block">
                <select id="role_id" name="role_id" lay-verType="tips" lay-verify="required|number">
                    ...
                    <?php if(is_array($roles) || $roles instanceof \think\Collection || $roles instanceof \think\Paginator): $i = 0; $__LIST__ = $roles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <option value="<?php echo htmlentities((string) $vo['id']); ?>" <?php if($detail['role_id']==$vo['id']): ?>selected<?php endif; ?>><?php echo htmlentities((string) $vo['name']); ?></option>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="nickname" name="nickname" value="<?php echo htmlentities((string) $detail['nickname']); ?>"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="username" name="username" value="<?php echo htmlentities((string) $detail['username']); ?>"
                       autocomplete="off" class="layui-input" lay-verType="tips" lay-verify="required">
            </div>
        </div>
        <!-- 登录密码 -->
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="password" id="password" name="password" placeholder="不填写则不修改"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="email" name="email" value="<?php echo htmlentities((string) $detail['email']); ?>"
                       autocomplete="off" class="layui-input" lay-verType="tips">
            </div>
        </div>
        <!-- 联系电话 -->
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="phone" name="phone" value="<?php echo htmlentities((string) $detail['phone']); ?>"
                       autocomplete="off" class="layui-input" lay-verType="tips">
            </div>
        </div>
        <!-- 状态 -->
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="is_disable" value="0" title="正常" <?php if($detail['is_disable']==0): ?>checked<?php endif; ?>>
                <input type="radio" name="is_disable" value="1" title="禁用" <?php if($detail['is_disable']==1): ?>checked<?php endif; ?>>
            </div>
        </div>
    </div>
