<?php /*a:2:{s:69:"/www/wwwroot/lundu.ecloudm.com/app/backend/view/diy/tabbar/index.html";i:1755524162;s:66:"/www/wwwroot/lundu.ecloudm.com/app/backend/view/common/layout.html";i:1764860923;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="phone">
                    <div class="bottom">
                        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <div class="item w-scale-<?php echo count($list); ?>">
                                <img src="<?php echo htmlentities((string) $vo['iconPath']); ?>" alt="icon">
                                <div><?php echo htmlentities((string) $vo['text']); ?></div>
                            </div>
                                ...
                                <div class="layui-input-block" style="margin-left:70px;">
                                    ...
                                    <div class="layui-inline">
                                        <input type="text" id="unselectedColorInput" name="unselectedColor"
                                               class="layui-input" value="<?php echo htmlentities((string) $style['unselectedColor']); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block" style="margin-left:70px;">
                                    ...
                                    <div class="layui-inline">
                                        <input type="text" id="selectedColorInput" name="selectedColor"
                                               class="layui-input" value="<?php echo htmlentities((string) $style['selectedColor']); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    layui.use(['form', 'colorpicker'], function() {
        ...
        colorpicker.render({
            ...
            color: '<?php echo htmlentities((string) $style['unselectedColor']); ?>'
        ...
        colorpicker.render({
            elem: '#selectedColor',
            color: '<?php echo htmlentities((string) $style['selectedColor']); ?>'
            ,change: function(color){
        ...
        waitUtil.table({
            ...
            ,url: '<?php echo route("diy.tabbar/index"); ?>'
            ,toolbar: false
            ,page: false
            ,cols: [[
        ...
        form.on('submit(addForm)', function(data){
            layer.confirm('确定保存当前配置吗?', function(index) {
                ...
                // 提交保存
                waitUtil.ajax({
                    url: '<?php echo route("diy.tabbar/save"); ?>',
                    type: 'POST',
