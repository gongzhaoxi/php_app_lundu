<?php /*a:2:{s:67:"/www/wwwroot/lundu.ecloudm.com/app/backend/view/auth/role/edit.html";i:1755524162;s:66:"/www/wwwroot/lundu.ecloudm.com/app/backend/view/common/layout.html";i:1764860923;}*/ ?>
<!DOCTYPE html>
...
<form class="layui-form">
    ...
    <div class="wait-body-content">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" id="sort" name="sort" value="<?php echo htmlentities((string) $detail['sort']); ?>"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="describe" name="describe" value="<?php echo htmlentities((string) $detail['describe']); ?>"
                       class="layui-input" autocomplete="off" lay-verType="tips">
            </div>
        </div>
        <!-- 角色状态 -->
...
<script>
    layui.use(['tree'], function () {
        ...
        tree.setChecked('treeMenu', JSON.parse('<?php echo $checked; ?>'))
    });
</script>
