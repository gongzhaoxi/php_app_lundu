<?php /*a:2:{s:71:"/www/wwwroot/lundu.ecloudm.com/app/backend/view/shipping_line/edit.html";i:1763649884;s:66:"/www/wwwroot/lundu.ecloudm.com/app/backend/view/common/layout.html";i:1755524162;}*/ ?>
<!DOCTYPE html>
...
<form class="layui-form">
    ...
    <div class="wait-body-content">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="name" name="name" autocomplete="off" value="<?php echo htmlentities((string) $detail['name']); ?>"
