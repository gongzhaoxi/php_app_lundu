<?php /*a:2:{s:64:"/www/wwwroot/lundu.ecloudm.com/app/backend/view/device/edit.html";i:1763651336;s:66:"/www/wwwroot/lundu.ecloudm.com/app/backend/view/common/layout.html";i:1764860923;}*/ ?>
<!DOCTYPE html>
...
<form class="layui-form">
    ...
    <div class="wait-body-content">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select id="type" name="type" lay-verify="required">
                    ...
                    <option value="<?php echo htmlentities((string) $k); ?>" <?php if($detail['type']==$k): ?>selected<?php endif; ?>><?php echo htmlentities((string) $v); ?></option>
					<?php endforeach; ?>
                </select>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select id="category" name="category" lay-verify="required">
                    ...
                    <option value="<?php echo htmlentities((string) $k); ?>" <?php if($detail['category']==$k): ?>selected<?php endif; ?>><?php echo htmlentities((string) $v); ?></option>
					<?php endforeach; ?>
                </select>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="sn" name="sn" autocomplete="off" value="<?php echo htmlentities((string) $detail['sn']); ?>"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="is_show" value="1" title="是" <?php if($detail['is_show']==1): ?>checked<?php endif; ?>>
                <input type="radio" name="is_show" value="0" title="否" <?php if($detail['is_show']==0): ?>checked<?php endif; ?>>
            </div>
        </div>
        <!-- 备注 -->
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="remark" name="remark" autocomplete="off" value="<?php echo htmlentities((string) $detail['remark']); ?>"
